...
export interface Coat {
  ...
  /** 纹/斑色（sheet palette swap 的 stripe 槽；无纹花色给深一档主色） */
  stripe: string;
...
export const COATS: Coat[] = [
  ...
  },
  {
    ...
    palette: { O: "#45414b", L: "#5b5663", E: "#f2c14e", P: "#8d8798", K: "#2e2b33" },
    stripe: "#5b5663", // 金眼
  },
  {
    id: "snow",
    name: { "zh-CN": "雪白", en: "Snow" },
    palette: { O: "#f7f5f2", L: "#ffffff", E: "#4a7fb5", P: "#f7c9d4", K: "#c9c4bd" },
    stripe: "#e3ded6", // 蓝眼、灰调轮廓保轮廓可见
  },
  {
    id: "cow",
  ...
  },
  {
    ...
    palette: { O: "#8f9aa8", L: "#c3ccd6", E: "#c77b3a", P: "#d9a8b8", K: OUTLINE },
    stripe: "#77828f", // 铜橙眼
  },
  {
    id: "siamese",
    name: { "zh-CN": "暹罗", en: "Siamese" },
    palette: { O: "#e8d5b5", L: "#f6ecd9", E: "#4a7fb5", P: "#f7b1c4", K: OUTLINE },
    stripe: "#5a4636", // 宝石蓝眼
    mask: { char: "D", areas: [
