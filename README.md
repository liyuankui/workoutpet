...
- 中英双语：跟随系统语言，托盘可切换
- **猫宇宙**（v0.11）：6 只猫 = 花色 ×7（奶油橘/玄猫/雪白/奶牛/三花/蓝灰/暹罗）× 性情 ×4（粘人精/活泼好动/老成持重/胆小谨慎）× 人设背景——性情真实改变行为（漫游频率/撒娇阈值/剧场偏好/台词池）；托盘「猫舍」用小鱼干迎接新猫（8🐟 同价）、「这只猫」看人设卡
...
- 托盘首项即版本号，「检查更新」比对 GitHub 最新版（气泡告知，不自动升级）
- 周报：托盘「复制周报」或 `bunx --bun micro-pet report`（需源码环境），数据在 `~/.micro-pet/streak.json`
- **小鱼干经济**：打卡 +1、达标日 +2、完整跟做 +1、抓到老鼠彩蛋 +1（日上限 8 防肝）+ 工作日 streak 里程碑（3/7/14/30 → 3/5/10/20）→ 换装 / 逗猫棒 / 迎新猫；本地 `inventory.json`，无付费无联网
- **工作日 streak**：只计周一~五（周末天然豁免——猫周末也在休息）；每月 2 天「猫咪代守」自动守护休假/出差
